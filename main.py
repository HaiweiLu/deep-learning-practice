...
from models.vgg import vgg19 as Net
...
# 数据集路径
parser.add_argument('--img_root_train', type=str, default= 'G:/垃圾分类', help='whether to img root')
# 模型及数据存储路径
parser.add_argument('--checkpoint_dir', type=str, default='D:/code_practice/ML_Project/earclassify/results/resnet18/', help='directory where model checkpoints are saved')
# 网络选择
parser.add_argument('--net', dest='net',type=str, default='vgg16', help='which net is chosen for training ')
# 批次
